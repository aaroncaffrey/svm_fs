...
namespace svm_fs
{
    public static class program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            var dataset = dataset_loader.read_binary_dataset($@"F:\dataset\2i_2n_2p_3i_3n_3p\", tp.negative_class_id, tp.positive_class_id, tp.class_names, use_parallel: true, perform_integrity_checks: false, fix_double: false, required_default, required_matches);
